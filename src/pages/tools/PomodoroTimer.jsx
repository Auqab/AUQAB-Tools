...
function PomodoroTimer() {
  ...
  return (
    <>
      <SEO
        title="Pomodoro Timer - AUQAB Tools"
      ...
      <section className="tool-page">
        <div className="password-card">
          ...
          <div style={{ display: "flex", gap: 10, justifyContent: "center" }}>
            <button className="generate" style={{ width: "auto" }} onClick={start} disabled={running}>
              Start
            </button>
            <button className="clear-btn" style={{ marginLeft: 0 }} onClick={stop}>
              Stop
            </button>
