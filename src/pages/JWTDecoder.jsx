...
function JWTDecoder() {
  ...
  return (
    <>
      <SEO title="JWT Debugger - AUQAB Tools" description="Decode and inspect JWT tokens." />
      <section className="tool-page">
        <div className="password-card">
          <h1>🛡️ JWT Debugger</h1>
          ...
          <button className="generate" onClick={decode} style={{ margin: "15px 0" }}>
            🔓 Decode JWT
          </button>
          ...
          {header && (
            <div className="jwt-section">
              ...
              <button className="copy-btn-mini" onClick={() => navigator.clipboard.writeText(formatJSON(header))}>📋</button>
            </div>
          )}
          ...
          {payload && (
            <div className="jwt-section">
              ...
              <button className="copy-btn-mini" onClick={() => navigator.clipboard.writeText(formatJSON(payload))}>📋</button>
            </div>
          )}
        </div>
      </section>
